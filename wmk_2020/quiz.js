...
function nextQuestion() {
    ...
    cardQuestion.innerHTML = (currentQuestionIndex+1) + "/" + quizData.length + ": " + q["question"];
    let buttons = [];
...
function onFinishQuiz() {
    ...
    let cardBody = document.getElementById("quiz-buttons");
    let cardQuestion = document.getElementById("quiz-question");
    cardBody.innerHTML = "Quiz Correct answers " + correctCount;
